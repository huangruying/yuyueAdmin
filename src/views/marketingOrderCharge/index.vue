    ...
    exportFile(){
      if(this.data.data.length <= 0){
        this.$message({
          ...
          window.location.href = `${baseUrl}/wash/bearercard/yyBearercardorderExport?type=3&goodsname=${goodsname}&name=${name}&status=${status}&bindMemPhone=${bindMemPhone}&code=${code}&startTime=${startTime}&endTime=${endTime}`
          // window.location.href = `${baseUrl}/wash/bearercard/yyBearercardorderExport?type=3&goodsname=${goodsname}&name=${name}&status=${status}&bindMemPhone=${bindMemPhone}&code=${code}&startTime=${startTime}&endTime=${endTime}`
      }
    },
    btn(index){
